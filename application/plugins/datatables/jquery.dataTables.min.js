    ...
    var L = function (h) {
        var j = function (e) {
            ...
            fnRowCallback: null, fnServerData: function (e, j, m, k) { k.jqXHR = h.ajax({ url: e, data: j, success: function (e) { e.sError && k.oApi._fnLog(k, 0, e.sError); h(k.oInstance).trigger("xhr", [k, e]); m(e) }, dataType: "json", cache: !1, type: k.sServerMethod, error: function (e, h) { "parsererror" == h && k.oApi._fnLog(k, 0, "DataTables warning: JSON data from server could not be parsed. This is caused by a JSON formatting error.") } }) }, fnServerParams: null, fnStateLoad: function (e) {
                ...
                oPaginate: { sFirst: "نخست", sLast: "آخرین", sNext: "بعدی", sPrevious: "قبلی" }, sEmptyTable: "داده ای جهت نمایش وجود ندارد.", sInfo: "نمایش صفحه _START_ تا _END_ از _TOTAL_ صفحه", sInfoEmpty: "صفحه ای وجود ندارد", sInfoFiltered: "(filtered from _MAX_ total entries)", sInfoPostFix: "", sInfoThousands: ",", sLengthMenu: "نمایش _MENU_ صفحه", sLoadingRecords: "در حال بارگیری...", sProcessing: "در حال پردازش...", sSearch: "جستوجو:", sUrl: "", sZeroRecords: "هیچ پرونده ای پیدا نشد."
