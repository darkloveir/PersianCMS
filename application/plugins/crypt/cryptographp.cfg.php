...
$noisepxmin = 2;      // Bruit: Nb minimum de pixels aléatoires
$noisepxmax = 2;      // Bruit: Nb maximum de pixels aléatoires

$noiselinemin = 2;     // Bruit: Nb minimum de lignes aléatoires
$noiselinemax = 2;     // Bruit: Nb maximum de lignes aléatoires

$nbcirclemin = 2;      // Bruit: Nb minimum de cercles aléatoires 
$nbcirclemax = 2;      // Bruit: Nb maximim de cercles aléatoires
